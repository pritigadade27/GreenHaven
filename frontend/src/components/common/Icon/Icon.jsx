const paths = {
  ...
  camera: (
    <>
      <path d="M3.5 8.5h3l1.5-2.5h6L15.5 8.5h5v11h-17Z" />
  ...
  repeat: (
    <>
      <path d="M4.5 11a7.5 7.5 0 0 1 12.9-5.2l2.1 2" />
      <path d="M19.5 13a7.5 7.5 0 0 1-12.9 5.2l-2.1-2" />
      <path d="M19.5 3.5v4.3h-4.3M4.5 20.5v-4.3h4.3" />
    </>
  ),
  calendar: (
    <>
